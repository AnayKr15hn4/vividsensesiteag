    ...
    <section id="join" className="bg-white py-24 md:py-32" ref={sectionRef}>
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <div className="mb-8">
              <span className="text-[11px] font-bold tracking-widest uppercase text-black/40">
                JOIN OUR TEAM
              </span>
            </div>
            <h2 className="text-6xl md:text-7xl lg:text-8xl font-display font-black leading-none tracking-tighter text-black">
              Join Our{" "}
              <ArrowRight className="inline-block w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 ml-4" />
              <br />
              Team
            </h2>
