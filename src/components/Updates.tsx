...
const updates = [
  {
    ...
    description:
      "Vividsense is now hiring two new positions. We are hiring a Media Manager and a Outreach Manager.",
    stat: "2",
  },
  {
    id: "003",
  ...
  },
  {
    ...
    label: "Dexarm V3",
    description:
      "The Dexarm version 2 is in progress. Featuring improved grip strength, lighter materials, and enhanced sensor feedback for more natural movement.",
    stat: "V3",
  },
];
    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <div className="overflow-hidden">
            <motion.div
              ...
              className="flex justify-between items-center text-[11px] font-bold tracking-widest uppercase mb-16 md:mb-24 text-black"
            >
              <span>03</span>
              <span>Updates</span>
            </motion.div>
        ...
        <div className="mb-16 md:mb-24">
          ...
          >
            Stay informed about our latest developments, feature releases, and
