...
const sections = [
  {
    ...
    number: "01",
    title: "Our Mission",
    text: "To empower independence through student-led innovation—creating affordable accessibility technology and running engineering workshops to foster the next generation of engineers.",
    highlight: "empower",
  },
  {
    id: "vision",
    number: "02",
    title: "Our Vision",
    text: "A future where assistive technology is accessible to all, powered by a student-led movement that bridges engineering education with impactful, real-world accessibility solutions.",
    highlight: "future",
  },
  {
    id: "values",
    number: "03",
    title: "Our Values",
    text: "Innovation, Education, and Impact. As a student-led initiative, we value user-centered accessibility design and hands-on mentorship to foster future engineering leaders.",
          ...
          <div className="lg:w-1/2 hidden lg:flex h-screen sticky top-0 items-center justify-start overflow-hidden">
            <div className="relative h-[200px] md:h-[400px] w-full flex items-center">
              ...
              <div className="h-[200px] md:h-[400px] overflow-hidden relative">
                <motion.div style={{ y: numberY }} className="flex flex-col">
                  {["1", "2", "3"].map((num) => (
                    <span
                      key={num}
          ...
          <div className="lg:w-1/2">
            {sections.map((section) => (
              ...
              >
                ...
                <div className="mb-12 relative flex items-start justify-end overflow-visible">
