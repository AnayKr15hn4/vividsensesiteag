...
const products: Product[] = [
  {
    ...
    description:
      "A wearable system with a forward-facing sensor that detects obstacles and provides real-time alerts.",
              ...
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  >
                    ...
                    <span className="text-[11px] uppercase tracking-[0.3em] font-bold text-black/40">
                      [{product.id}]
                    </span>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="mb-8"
                  >
                    <span className="text-3xl md:text-4xl font-display font-medium tracking-tight text-black block mb-8">
                      {product.price}
                    </span>
                    {product.id === "001" ? (
                      <Link
                        to="/product/surrounding-scanner"
